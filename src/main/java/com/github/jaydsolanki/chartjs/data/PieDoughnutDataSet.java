...
public class PieDoughnutDataSet extends DataSet {

	public PieDoughnutDataSet(double dataPoint, ChartJsColor fillColor,
	...
	public PieDoughnutDataSet(String label, double dataPoint,
