...
public class RadarDataSet extends DataSet {
	...
	public RadarDataSet(List<?> dataSet) {
		...
		setPointStrokeColor(new ChartJsHexColor(ChartJsColor.StoredColors.WHITE));
		setPointHighlightFill(new ChartJsHexColor(ChartJsColor.StoredColors.WHITE));
